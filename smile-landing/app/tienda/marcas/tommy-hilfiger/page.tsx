const products = [
  ...
  {
    name: "Tommy Hilfiger Modern Steel",
    image: "/images/bg-tommy.jpg",
    category: "Relojes",
  },
  {
    name: "Tommy Hilfiger Signature",
    image: "/images/bg-tommy.jpg",
    category: "Relojes",
  },
];
      ...
      <section className="border-b border-white/10 px-6 pb-16 pt-28 md:px-12 md:pb-20 md:pt-32">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mt-6 max-w-2xl text-sm leading-7 text-white/68 md:text-base">
            Diseño contemporáneo, estética refinada y una presencia visual
            moderna con firma reconocible.
          </p>
        </div>
      </section>
